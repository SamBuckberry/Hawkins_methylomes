...
methylC-seq reads were aligned to hg19 and methylation quantified using [BSeeker2](http://bmcgenomics.biomedcentral.com/articles/10.1186/1471-2164-14-774) and [Bowtie2](http://www.nature.com/nmeth/journal/v9/n4/full/nmeth.1923.html) using the end-to-end mode. 
 
To identify differentially methylated regions (DMRs), CG dinucleotide data for each strand were merged with differential regions identified using [DSS](http://nar.oxfordjournals.org/content/early/2015/07/15/nar.gkv715.full) with detection p-values <0.01, delta-mC > 0.2, number of CG's >= 3, window size > 50 and merging of DMRs with < 100 bases between them. Samples with replicates were merged before calling DMRs. 
...
To visualise differences in mC between cell types, DMR regions were merged 
